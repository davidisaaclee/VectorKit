Pod::Spec.new do |s|
  ...
  s.name         = "VectorKit"
  s.version      = "1.0.0"
  s.summary      = "Powerful vector operations for any type."
  ...
  s.source       = { :git => "https://github.com/davidisaaclee/VectorKit.git", :tag => "0.1.0" }
  ...
  s.source_files  = "Pod/Classes", "Pod/Classes/**/*.swift"
